...
CPU::CPU()
{
    lookup =
    {
            ...
            {&CPU::JSR, &CPU::ABY_Addr, 6}, {&CPU::AND, &CPU::IZX_Addr, 6}, {&CPU::IOC, &CPU::IMP_Addr, 2}, {&CPU::IOC, &CPU::IZX_Addr, 8}, {&CPU::BIT, &CPU::ZPO_Addr, 3}, {&CPU::AND, &CPU::ZPX_Addr, 3}, {&CPU::ROL, &CPU::ZPO_Addr, 5}, {&CPU::IOC, &CPU::ZPO_Addr, 5}, {&CPU::PLP, &CPU::IMP_Addr, 4}, {&CPU::AND, &CPU::IMM_Addr, 2}, {&CPU::ROL, &CPU::IMP_Addr, 2}, {&CPU::IOC, &CPU::IMM_Addr, 2}, {&CPU::BIT, &CPU::ABS_Addr, 4}, {&CPU::AND, &CPU::ABS_Addr, 4}, {&CPU::ROL, &CPU::ABS_Addr, 4}, {&CPU::IOC, &CPU::ABS_Addr, 6},
            ...
            {&CPU::RTI, &CPU::IMP_Addr, 6}, {&CPU::EOR, &CPU::IZX_Addr, 6}, {&CPU::IOC, &CPU::IMP_Addr, 2}, {&CPU::IOC, &CPU::IZX_Addr, 8}, {&CPU::NOP, &CPU::ZPO_Addr, 3}, {&CPU::EOR, &CPU::ZPO_Addr, 3}, {&CPU::LSR, &CPU::ZPO_Addr, 5}, {&CPU::IOC, &CPU::ZPO_Addr, 5}, {&CPU::PHA, &CPU::IMP_Addr, 3}, {&CPU::EOR, &CPU::IMM_Addr, 2}, {&CPU::LSR, &CPU::IMP_Addr, 2}, {&CPU::IOC, &CPU::IMM_Addr, 2}, {&CPU::JMP, &CPU::ABS_Addr, 3}, {&CPU::EOR, &CPU::ABS_Addr, 4}, {&CPU::LSR, &CPU::ABS_Addr, 6}, {&CPU::IOC, &CPU::ABS_Addr, 6},
            ...
            {&CPU::RTS, &CPU::IMP_Addr, 6}, {&CPU::ADC, &CPU::IZX_Addr, 5}, {&CPU::IOC, &CPU::IMP_Addr, 2}, {&CPU::IOC, &CPU::IZX_Addr, 8}, {&CPU::NOP, &CPU::ZPO_Addr, 3}, {&CPU::ADC, &CPU::ZPO_Addr, 3}, {&CPU::ROR, &CPU::ZPO_Addr, 5}, {&CPU::IOC, &CPU::ZPO_Addr, 5}, {&CPU::PLA, &CPU::IMP_Addr, 4}, {&CPU::ADC, &CPU::IMM_Addr, 2}, {&CPU::ROR, &CPU::IMP_Addr, 2}, {&CPU::IOC, &CPU::IMM_Addr, 2}, {&CPU::JMP, &CPU::IND_Addr, 5}, {&CPU::ADC, &CPU::ABS_Addr, 4}, {&CPU::ROR, &CPU::ABS_Addr, 6}, {&CPU::IOC, &CPU::ABS_Addr, 6},
