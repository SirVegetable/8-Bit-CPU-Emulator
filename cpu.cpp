...
CPU::CPU()
{
    lookup =
    {
            ...
            {&CPU::BNE, &CPU::REL_Addr, 2}, {&CPU::CMP, &CPU::IZY_Addr, 5}, {&CPU::IOC, &CPU::IMM_Addr, 2}, {&CPU::IOC, &CPU::IZY_Addr, 8}, {&CPU::NOP, &CPU::ZPX_Addr, 4}, {&CPU::CMP, &CPU::ZPX_Addr, 4}, {&CPU::DEC, &CPU::ZPX_Addr, 6}, {&CPU::IOC, &CPU::ZPX_Addr, 6}, {&CPU::CLD, &CPU::IMM_Addr, 2}, {&CPU::CMP, &CPU::ABY_Addr, 4}, {&CPU::NOP, &CPU::IMP_Addr, 2}, {&CPU::IOC, &CPU::ABY_Addr, 7}, {&CPU::NOP, &CPU::ABX_Addr, 4}, {&CPU::CMP, &CPU::ABX_Addr, 4}, {&CPU::DEC, &CPU::ABX_Addr, 7}, {&CPU::IOC, &CPU::ABX_Addr, 7},
    };
