...
CPU::CPU()
{
    lookup =
    {
            ...
            {&CPU::CPY, &CPU::IMM_Addr, 2}, {&CPU::CMP, &CPU::IZX_Addr, 6}, {&CPU::NOP, &CPU::IMM_Addr, 2}, {&CPU::IOC, &CPU::IZX_Addr, 8}, {&CPU::CPY, &CPU::ZPO_Addr, 3}, {&CPU::CMP, &CPU::ZPO_Addr, 3}, {&CPU::DEC, &CPU::ZPO_Addr, 5}, {&CPU::IOC, &CPU::ZPO_Addr, 5}, {&CPU::INY, &CPU::IMP_Addr, 2}, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, },
            {&CPU::BNE, &CPU::REL_Addr, 2}, {&CPU::CMP, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, }, {&CPU::, &CPU::, },
    };
